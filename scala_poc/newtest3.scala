...
val m4 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "26500", "assetType" -> "VodAsset", "startOverPoint" -> "12000", "liveTuneType" -> "Catch-up", "programStartTime" -> "10000", "programEndTime" -> "25000")
...
val m6 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "27001", "currentWatchPoint" -> "10000", "liveTuneType" -> "On-now", "programEndTime" -> "25000", "assetType" -> "LinearAsset")
val  events_simple_timesift_case_1 = List(
