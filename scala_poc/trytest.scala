...
val m5 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "16500", "currentWatchPoint" -> "16500", "liveTuneType" -> "On-now", "programEndTime" -> "25000")
...
******/
val tmp =  getSortedSection(events_simple_timesift_case_1, "Regular")
val tmp0 = getSortedSection(events_simple_timesift_case_1, "Time-Shift")
val tmp1 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1, "Time-Shift").filter(x => x._3 == "Time-Shift"), 0).toLong
val tmp2 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1, "Time-Shift").filter(x => x._3 == "Catch-up"), 0).toLong
val tmp3 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1, "Time-Shift").filter(x => x._3 ==  "On-now"), 0).toLong
val tmp4 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1, "Regular"), 0).toLong
val tmp5 = sumVideoStreamDistinctDuration(getSortedSection(events_simple_timesift_case_1, "Regular"), 0, 0).toLong
println("\n*************************************************************************************************************************************")
println("\nSections -> "+tmp0)
