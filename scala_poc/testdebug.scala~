...
val m1 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "1386619315632", "currentWatchPoint" -> "1386619201000", "liveTuneType" -> "On-now", "programEndTime" -> "1386626400000")
val m4 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "1386626515516", "trickStartPoint" -> "1386619200000", "trickEndPoint" -> "1386626400000", "liveTuneType" -> "Catch-up", "programEndTime" -> "1386626400000")
val m5 = Map("profileId" -> "26386", "ip" -> "99.111.73.147", "deviceTimestamp" -> "1386626515517", "currentWatchPoint" -> "1386626401000", "liveTuneType" -> "Catch-up", "programEndTime" -> "1386626400000")
...
******/
val tmp =  getSortedSection(events_simple_timesift_case_1)
val tmp0 = getSortedSection(events_simple_timesift_case_1)
val tmp1 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1).filter(x => x._3 == "Time-Shift"), 0).toLong
val tmp2 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1).filter(x => x._3 == "Catch-up"), 0).toLong
val tmp3 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1).filter(x => x._3 ==  "On-now"), 0).toLong
val tmp4 = sumVideoStreamDuration(getSortedSection(events_simple_timesift_case_1), 0).toLong
val tmp5 = sumVideoStreamDistinctDuration(getSortedSection(events_simple_timesift_case_1), 0, 0).toLong
println("\n*************************************************************************************************************************************")
println("\nSections regular -> "+tmp)
println("\nSections time shift -> "+tmp0)
